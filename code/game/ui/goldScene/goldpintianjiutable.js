gameclass.goldpintianjiutable = gameclass.baseui.extend({
    node:null,
    mod_ptj:null,
    playerHeads:null,
    nodebgArr:null,
    ...
    setptjtype:function(){
        ...
        var usejinbi = [50*0.5 , 100 *.05 , 200 *0.5 , 300*0.5 , 500*0.5 , 1000*0.5];
        var index = parseInt(this.mod_ptj.roominfo.type/10)%10;
        ccui.helper.seekWidgetByName(this.node,"usegoldnum").setString("本场每局消耗"+ usejinbi[index] +"金币");
    },
    show:function(){
...
gameclass.goldpintianjiutable.prototype.onChat = function(index,data){
 ...
 * 开局前 玩家离开当前游戏
 * */
gameclass.goldpintianjiutable.prototype.userExitRoom = function(index){

    this.playerHeads[index].reset();
    this.playerHeads[index].setVisible(false);
};

gameclass.goldpintianjiutable.prototype.checkSafe = function(people){
    this.safeLayer.checkSafe(people);
};

gameclass.goldpintianjiutable.prototype.init = function(){

    this.node = this.game.uimgr.createnode(res.goldpintianjiutable,true);
    ...
    gameclass.createbtnpress(_this.node, "ready", function () {
        ...
        remaincardbg.setPosition(cc.p(568,320));
        if(_this.mod_ptj.isoneover){
    ...
    var dianchi = ccui.helper.seekWidgetByName(_this.node,"dianchi");
    ...
    gameclass.createbtnpress(this.node, "invitebtn", function () {
        _this.mod_ptj.roominfo.goldchang = true;
        _this.mod_ptj.dissmissroom();
    });
        ...
        switch (type) {
            case ccui.Widget.TOUCH_ENDED:
                ...
                if(_this.xiadaonum == 1){
                    ...
                    ccui.helper.seekWidgetByName(_this.node, "showxiazhu3").setVisible(true);
                }
...
gameclass.goldpintianjiutable.prototype.getchangcard = function(max,min){
    var _this = this;  var ischangpos = [0,0,0,0];
...
gameclass.goldpintianjiutable.prototype.playsoundcard = function (smax1,smin2) {
    var _this = this;
...
gameclass.goldpintianjiutable.prototype.kaipainame = function(groupmax,groupmin) {
...
gameclass.goldpintianjiutable.prototype.updatePlayerinfo = function(bool){
...
gameclass.goldpintianjiutable.prototype.showReady = function(index){
...
gameclass.goldpintianjiutable.prototype.setshowdaojishi = function (time) {
    var bool = true;
...
//游戏开始（发牌）
gameclass.goldpintianjiutable.prototype.showtablecard = function(msgdata,bool) {
    var _this = this; var sucAnim;
    ...
    var startgame = function () {
        if(bool) {
            _this.isduijubegin = false;
            _this._timeContain.setVisible(true);
            if(sucAnim){
                sucAnim.clearTrack(19);
                sucAnim.removeFromParent();
            }
        }
        for(var i = 0; i < 4; i++){
        ...
        for(var j = 0 ; j < msgdata.info.length; j++){
            ...
            if(msgdata.info[j].dealer){
                ishavedealer = true;
                for(var m = 0 ; m < 4; m++){
                    if(_this.playerHeads[m].uid == msgdata.info[j].uid){
                        _this.playerHeads[m].zhuang.setVisible(true);
                        _this.playerHeads[m].selectbg0.setVisible(false);
                        _this.playerHeads[m].selectbg1.setVisible(false);
                        _this.playerHeads[m].selectbg2.setVisible(false);
                        _this.dearchair = m;
                        if(chair == 0) mydealer = true;
                    }else{
                        _this.playerHeads[m].zhuang.setVisible(false);
                        _this.playerHeads[m].selectbg0.setVisible(true);
                        _this.playerHeads[m].selectbg1.setVisible(true);
                        _this.playerHeads[m].selectbg2.setVisible(true);
                    }
                }
            }else{
    ...
    if(bool) {
        ...
        sucAnim = new sp.SkeletonAnimation(res.duijukaishi_j, res.duijukaishi_a);
        sucAnim.setAnimation(89, 'animation', false);
        sucAnim.setAnchorPoint(0.5, 0.5);
        sucAnim.setPosition(1136 / 2, 320);
        //sucAnim.setCompleteListener(startgame);
 ...
 * 创建
 * */
gameclass.goldpintianjiutable.prototype.createCard = function(card,up) {
    var cardImage;
    if(up){
...
gameclass.goldpintianjiutable.prototype.showtouzicard = function(msgdata){
    var _this = this;

    _this.myviewlist = msgdata.card;
    ccui.helper.seekWidgetByName(_this.node, "selectscorebg").setVisible(false);
    ccui.helper.seekWidgetByName(_this.node, "showxiazhu1").setVisible(false);
    ccui.helper.seekWidgetByName(_this.node, "showxiazhu2").setVisible(false);
    ccui.helper.seekWidgetByName(_this.node, "showxiazhu3").setVisible(false);

    _this.touziFunc(msgdata.sz);
    mod_sound.playeffect(g_music["game_ptj_rocksezi"], false);//
};
//发牌以及动画
gameclass.goldpintianjiutable.prototype.cardRunaction = function(chair,next,isant,viewobj) {
...
gameclass.goldpintianjiutable.prototype.update = function(){
...
//小牌九开牌动画
gameclass.goldpintianjiutable.prototype.kaipaiAnimation = function() {

    mod_sound.playeffect(g_music["game_ptj_kaicard"], false);
    this.myiskaipai = true;
...
//翻牌动画//显示牌值
gameclass.goldpintianjiutable.prototype.fanpaiAnimation = function ( viewcardsnum,nodebgArrindex,isant ){
    var _this = this;
...
gameclass.goldpintianjiutable.prototype.selectgroup = function (selector, target) {
    var _this = this;
    if(_this.ptjtype == 1){
        //var beginx = 0;
        switch (target){
...
gameclass.goldpintianjiutable.prototype.touziFunc = function ( touzinums )
{
    var _this = this;
    ...
    var removeSprite = function()
    {
        ...
        var dearc = _this.dearchair+(_this.mod_ptj.beginchair-1)%4;
        if(dearc >= 4) dearc = dearc-4;
        //cc.log(dearc+",dearchair="+_this.dearchair+",beginchair="+_this.mod_ptj.beginchair);
...
gameclass.goldpintianjiutable.prototype.showbets = function(msgdata) {
    var _this = this;
    ...
    var bet1 = parseInt(msgdata.bets/100)%100;
    var bets1 = "ptj_x" + bet1 + ".png";//百位和千位
    //cc.log(bets1,bets0,chair);
    _this.playerHeads[chair].selectbg1.setVisible(true);

    var bets2 = "";var bet2 = parseInt(msgdata.bets/10000);

    bets2 = "ptj_x" + bet2 + ".png";//万位和十万位
    ...
    if(chair==1) {
        ...
        _this.playerHeads[chair].selectscore1.initWithSpriteFrameName(bets1);
        _this.playerHeads[chair].selectscore2.initWithSpriteFrameName(bets2);
    }
};

gameclass.goldpintianjiutable.prototype.robzhuang = function(uid,ok) {
    var _this = this;
    if(ok){
        var chair = _this.mod_ptj.getchairbyuid(uid);
        _this.isrobzh[chair] = 1;
        //cc.log(_this.isrobzh,chair,uid)
    }
};

//抢庄成功
gameclass.goldpintianjiutable.prototype.robzhuangsus = function(uid) {
    var _this = this; var flag = false; var nobodyrob = 0;
    ccui.helper.seekWidgetByName(_this.node, "ptj_buqiangz").setVisible(false);
    ccui.helper.seekWidgetByName(_this.node, "ptj_qiangzh").setVisible(false);
    ...
    for(var i = 0; i < _this.playerHeads.length; i++){
        if(_this.playerHeads[i].ishaves){
            if(_this.playerHeads[i].uid == uid) {
                ...
                _this.playerHeads[i].selectbg2.setVisible(true);
            }
            if(_this.isrobzh[i] == 1) {
                _this.isrobzh[i] = 0;
                if(nobodyrob == 1){
...
//普通牌组合选出最大的
gameclass.goldpintianjiutable.prototype.tishiselectgroup = function() {
    //this.allcardsnum[21]
...
gameclass.goldpintianjiutable.prototype.teshuGroupscard = function(group1,group2 ,tempgroupmax,tempgroupmin){
    var _this = this;
    if(group1 > 900 && group2 < 900){
...
gameclass.goldpintianjiutable.prototype.autoGroupscard = function(groupmax,groupmin) {
...
gameclass.goldpintianjiutable.prototype.showgroupnameSpr = function(groupmax,groupmin,bool) {
    var _this = this;
...
gameclass.goldpintianjiutable.prototype.findtabelgroup = function(groups) {
...
//返回png
gameclass.goldpintianjiutable.prototype.showgroupname = function(groups) {
...
gameclass.goldpintianjiutable.prototype.findmaxgroup = function(g1, g2){
...
//服务器发来
gameclass.goldpintianjiutable.prototype.showplayerkaipai = function(chair) {
    if(chair == 0) {
        return;
    }
    var _this = this;
...
gameclass.goldpintianjiutable.prototype.cleartable = function() {
    ...
    var remaincardbg = ccui.helper.seekWidgetByName(this.node, "remaincardbg");
    remaincardbg.removeAllChildren(true);
    this.nodebgArr = [];
    this.myiskaipai = false;
};
//刷新金币
gameclass.goldpintianjiutable.prototype.refreshgold = function(msgdata) {
    for(var i=0; i < msgdata.info.length; i++){
        var chair = this.mod_ptj.getchairbyuid(msgdata.info[i].uid);
        this.playerHeads[chair].playerscore.setString(""+gameclass.changeShow(msgdata.info[i].total));
    }
}
//单局结算
gameclass.goldpintianjiutable.prototype.resultOnend = function(msgdata) {
    //首先显示翻牌，接着比牌输赢
    var _this = this; var dearPos = cc.p(0,0); var dearscore = 0; var myselfscore = 0;
    for(var i=0; i < msgdata.info.length; i++){
        //先找到庄家的pos
        ...
        if(_this.game.modmgr.mod_login.logindata.uid == msgdata.info[i].uid){
            myselfscore = msgdata.info[i].score;
        }
    }
    ccui.helper.seekWidgetByName(_this.node, "ptj_tishi").setVisible(false);
    ccui.helper.seekWidgetByName(_this.node, "ptj_showpai").setVisible(false);
    for(var i=0; i < msgdata.info.length; i++){
        var chair = _this.mod_ptj.getchairbyuid(msgdata.info[i].uid);
        _this.playerHeads[chair].playerscore.setString(""+gameclass.changeShow(msgdata.info[i].total));
        ...
        if(chair == 2) fenPos = cc.p(fenPos.x,fenPos.y-90);
        else if(chair == 3) fenPos = cc.p(fenPos.x+40,fenPos.y+90);
        else fenPos = cc.p(fenPos.x,fenPos.y+90);
        ...
        if(chair){
            ...
            for(var j = 0; j < msgdata.info[i].card.length; j++){
                //if(chair == 0) break;
                //cc.log(chair,_this.playercardindex[chair]);
                        ...
                        for(var m=0; m < msgdata.info.length; m++){
                            ...
                            if(chair1 == 0){
                                if(_this.mod_ptj.isviewer){
                                    ccui.helper.seekWidgetByName(_this.node, "guanZhanImg").setVisible(true);
                                    ccui.helper.seekWidgetByName(_this.node, "invitebtn").setVisible(true);
                                }else if(!_this.myiskaipai){
                                    if(_this.ptjtype == 1)
                                        _this.kaipaiAnimation();
                                    else{
                                        _this.getchangcard([msgdata.info[m].card[0],msgdata.info[m].card[1]],[msgdata.info[m].card[2],msgdata.info[m].card[3]]);
                                    }
                                }
                            }else{
                                var tempcard = [];
                                ...
                                for(var n = 0; n < tempcard.length; n++){
                                    ...
                                    if(n == 1){
                                        ...
                                        if(chair1 == 2){
                                            if(_this.ptjtype == 1)
                                                sprmaxname.setPositionX(80);
                                            else
                                                sprmaxname.setPositionX(20);
                                        }
                                    }
                ...
                if(nodecard) nodecard.runAction(seq);
            }
        }
...
gameclass.goldpintianjiutable.prototype.playerEndAnim = function(_score){
    var sucAnim = null;
    var _this = this;
    var removeSprite = function () {
        ccui.helper.seekWidgetByName(_this.node, "invitebtn").setVisible(true);
...
gameclass.goldpintianjiutable.prototype.findnametabelgroup = function(maxtype){
    var name = "";
    var groupstable =  this.groupstable;
    for(var i = 0; i < groupstable.length; i++){
...
gameclass.goldpintianjiutable.prototype.getptjson = function() {
    var _this = this;
...
gameclass.goldpintianjiutable.prototype.userLineOut =  function(index,data){
